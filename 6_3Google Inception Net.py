...
def inception_v3_arg_scope(weight_decay=0.00004, stddev=0.1, batch_norm_var_collection='moving_vars'):
    ...
    # slim.arg_scope-给函数的参数自动赋予某些默认值
...
def inception_v3_base(inputs, scope=None):
    ...
    with tf.variable_scope(scope, 'InceptionV3', [inputs]):
        ...
        # 第一个Inception模块组,包含3个Inception Module
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
            # 第一个Inception模块组中的第一个Inception Module-Mixed_5b，包含四个分支
            ...
            # 第一个Inception模块组中的第二个Inception Module-Mixed_5c
            with tf.variable_scope('Mixed_5c'):
                with tf.variable_scope('Branch_0'):
                    branch_0 = slim.conv2d(net, 641, [1, 1], scope='Conv2d_0a_1x1')
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net, 48, [1, 1], scope='Conv2d_0a_1x1')
                    branch_1 = slim.conv2d(branch_1, 64, [5, 5], scope='Conv2d_0b_5x5')
                with tf.variable_scope('Branch_2'):
            ...
            # 第一个Inception模块组中的第三个Inception Module-Mixed_5d
            ...
            # 第二个Inception模块组,包含5个Inception Module
            # 第二个Inception模块组中的第一个Inception Module-Mixed_6a
            ...
            # 第二个Inception模块组中的第二个Inception Module-Mixed_6b
            ...
            # 第二个Inception模块组中的第三个Inception Module-Mixed_6c
            ...
            # 第二个Inception模块组中的第四个Inception Module-Mixed_6d
            ...
            # 第二个Inception模块组中的第五个Inception Module-Mixed_6e
            with tf.variable_scope('Mixed_6e'):
                ...
                with tf.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3, 192, [1, 1], scope='Conv2d_0b_1x1')
                net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
            # 将Mixed_6e存储于end_points中，作为辅助类型的分类
            end_points['Mixed_6e'] = net

            # 第三个Inception模块组,包含3个Inception Module
            # 第三个Inception模块组中的第一个Inception Module-Mixed_7a
            ...
            # 第三个Inception模块组中的第二个Inception Module-Mixed_7b
            ...
            # 第三个Inception模块组中的第三个Inception Module-Mixed_7c
